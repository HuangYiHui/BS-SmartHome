...
const unsigned char ZBC::STARTUP_FROM_APP[7] = {0xfe, 0x02, 0x25, 0x40, 0x00, 0x00, 0x67};
const unsigned char ZBC::ZDO_DIRECT_CB[8] = {SOF, 0x03, 0x26, 0x05, 0x8f, 0x01, 0x01, 0xaf};
...
const ZBCmd ZBC::CMD_ZDO_DIRECT_CB = {(unsigned char*)ZDO_DIRECT_CB, 8};
const ZBCmd ZBC::CMD_STARTUP_FROM_APP = {(unsigned char*)STARTUP_FROM_APP, 7};
