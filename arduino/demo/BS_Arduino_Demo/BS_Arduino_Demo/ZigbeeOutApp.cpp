...
ZigbeeOutApp::ZigbeeOutApp(unsigned int appID, ZigbeeDevice& zigbee) : SampleApp(appID), zigbee(zigbee)
{
	zbPacketTransID = 0;
	state = APP_STATE_UNREADY;
}

void ZigbeeOutApp::init()
{
	ZBAppReg appRegs[1];
	appRegs[0] = ZBAppReg();
...
void ZigbeeOutApp::receiveZigbeeMsg()
{
