...
public class UploadDataToHttpServerMsg implements IMsg {
	...
	public final static short SENDOR_ID_IN_TEMPERATURE 	= 20;
	public final static short SENDOR_ID_IN_HUMIDITY 	= 21;
	public final static short SENDOR_ID_IN_HEAT 		= 22;
	public final static short SENDOR_ID_OUT_TEMPERATURE = 26;
	public final static short SENDOR_ID_OUT_HUMIDITY 	= 27;
	public final static short SENDOR_ID_OUT_HEAT 		= 28;
